(() => {
    ...
    let hederBurger = document.querySelector(".heder__burger");
    let menuBurger = document.querySelector(".menu-burger");
    let headerSubText = document.querySelector(".header__sub-text");
    hederBurger.addEventListener("click", (function(e) {
        hederBurger.classList.toggle("open-menu");
        menuBurger.classList.toggle("open-menu");
        headerSubText.classList.toggle("open-menu");
        _slideToggle(hederBurger);
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
